            ...
            if (!$rootScope.data.sourceDescription) {
                var sourceDescription = new fsAPI.SourceDescription(
                    fsUtils.removeEmptyProperties(
                        {
                            about: $rootScope.data.url ? $rootScope.data.url : '',
                            citation: $rootScope.data.citation ? $rootScope.data.citation : '',
                            title: $rootScope.data.title ? $rootScope.data.title : '',
                            text: $rootScope.data.notes ? $rootScope.data.notes : ''
                        }
                    )
                );
